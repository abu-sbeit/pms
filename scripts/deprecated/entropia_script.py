...
def get_name(dataset, method):
  basedir = f'/Users/abdalrhman/Documents/thesis_data/process_trees_medium_ws2'
  if method == 'gcn_sound':
...
def test_data(datadir, samples):
  ...
  for dataset in datasets:
    ...
    skip = False
    for method in methods:
      entropia = Entropia(dataset, method, datadir='/Users/abdalrhman/Documents/thesis_data/process_trees_medium_ws2', namegetter=get_name)
...
if __name__ == '__main__':
  ...
  directory = {
    'simple': '/Users/abdalrhman/Documents/thesis_data/process_trees_simple_ws2/predictions',
    'complex': '/Users/abdalrhman/Documents/thesis_data/process_trees_complex_ws/predictions'
  }[method]
  mf_model = {'simple': 'gcn_ep144b', 'complex': 'gcn_ep100b'}[method]
  samples = {'simple': range(1970, 2627), 'complex': range(1488, 1985)}[method]

  datadir = f'/Users/abdalrhman/Documents/thesis_data/'
  test_data()
...
models = [
  ('/Users/abdalrhman/Documents/apd-ml/project/ml_models/models/simple_ws2_frequency_144_.pth', 'simpleep144'),
  ('/Users/abdalrhman/Documents/apd-ml/project/ml_models/models/complex_ws_frequency_100_.pth', 'complexep100')
]
for dataset, tx in tqdm.tqdm(datasets):
  for model, ex in tqdm.tqdm(models):
    ...
    '''
    d = '/Users/abdalrhman/Documents/thesis_data/evaluation_data'
